...
import { isCollection, isIndex, getIndexPage } from '../utils.js';
...
let PageLink = class PageLink extends Component {
  static {
  ...
  get isActive() {
    let subPath1 = this.args.item.path;
    if (subPath1 === '/') return false;
    return this.router.currentURL?.startsWith(subPath1) ?? false;
  }
  static {
